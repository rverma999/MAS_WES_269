...
int main(void) {
	nrf_802154_channel_set(12u); // changed to channel 12
	...
	uint8_t pan_id[] = {0xdd, 0xdd};
	nrf_802154_pan_id_set(pan_id);

	// set the extended address (8 bytes, little-endian)
	//uint8_t extended_addr[] = {0x50, 0xbe, 0xca, 0xc3, 0xde, 0xad, 0xbe, 0xef};
	//nrf_802154_extended_address_set(extended_addr);
	uint8_t short_addr[] = {0xca, 0xfe};
